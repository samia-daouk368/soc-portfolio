                                                                                                                                                      ...
                                                                                                                                                      - - Subnetting — splitting a network via a subnet mask (4 octets/32 bits); Network address (start of subnet), Host address (a device), Default Gateway (off-subnet router, e.g. .1 or .254)
                                                                                                                                                        - - ARP (Address Resolution Protocol) — maps IP ↔ MAC via ARP Request/Reply, cached locally
                                                                                                                                                          - - DHCP handshake (DORA): Discover → Offer → Request → ACK
                                                                                                                                                            ...
                                                                                                                                                            - ### OSI Model (Layer 7 → 1)
                                                                                                                                                            - 1. Application — HTTP, DNS, browsers/email clients
                                                                                                                                                              2. 2. Presentation — data translation/formatting, encryption (e.g. HTTPS)
                                                                                                                                                                 3. 3. Session — establishes/maintains/closes a connection ("session")
                                                                                                                                                                    4. 4. Transport — TCP (reliable) / UDP (fast, unreliable); ports
                                                                                                                                                                       5. 5. Network — IP addressing, routing (OSPF, RIP); routers = "Layer 3 devices"
                                                                                                                                                                          6. 6. Data Link — MAC addressing via NIC; frames
                                                                                                                                                                          7. Physical — cables, raw electrical signals, binary
